...
//		val deployments = getEObjectDescriptions(resource, AmeliaPackage.eINSTANCE.deploymentDeclaration)
	...
	def getDefaultMainImpl(Iterable<Subsystem> subsystems) {
		val s = org.amelia.dsl.lib.Subsystem.simpleName
		'''
			/*
			 * This file was generated by Amelia
			 * «new Date()»
			 */
			import «org.amelia.dsl.lib.Subsystem.canonicalName»;
			import «SubsystemGraph.canonicalName»;
			...
			public class Amelia {
				public static void main(String[] args) throws InterruptedException {
					...
					«FOR subsystem : subsystems»
						«s» «subsystem.javaName» = new «s»("«subsystem.fullyQualifiedName»", new «subsystem.fullyQualifiedName»());
					«ENDFOR»
					...
					// Execution setup
					«SubsystemGraph.simpleName» graph = «SubsystemGraph.simpleName».getInstance();
					graph.addSubsystems(«subsystems.map[r|r.javaName].join(", ")»);
					graph.execute(true);
				}
			}
		'''
	...
	def javaName(Subsystem subsystem) {
